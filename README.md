...
### 실행파일은 exe이고, 저장은 무조건 png로만 돼요, 그냥 그렇게 했습니다. 
...
### 만약 소스코드를 변경해서 재배포하거나, 다른 곳에 이 프로그램을 공유 하실 일이 있다면 여기 링크 하나만 남겨주십쇼... 
### 그 외에는 바라는 거 없습니다. 어차피 소스코드 일부는 챗지피티에게 시킨 사이드 프로젝트이기 때문에. 
